// src/admin/components/charts/ProfileViewsPerMinuteChart.tsx
...
interface ProfileViewsPerMinuteChartProps {
  value: number | null;
}

export default function ProfileViewsPerMinuteChart({
  value,
}: ProfileViewsPerMinuteChartProps) {
